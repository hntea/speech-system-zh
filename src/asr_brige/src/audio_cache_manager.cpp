...
public:
	CacheManger(){
		...
		_pub1 = _nh.advertise<audio_msgs::AudioData>("cache_data",1000);
		_pub2 = _nh.advertise<std_msgs::String>("cache_state",20);
		ros::spin();
	}
	~CacheManger(){
...
int main (int argc, char **argv)
{
  ...
  ROS_INFO("Ros Node Publish Topic : cache_state and cache_data");
